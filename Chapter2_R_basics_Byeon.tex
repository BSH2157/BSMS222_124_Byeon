...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a }\OtherTok{\textless{}{-}}\NormalTok{ murders}\SpecialCharTok{$}\NormalTok{state}
\FunctionTok{class}\NormalTok{(a)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(murders}\SpecialCharTok{$}\NormalTok{region, murders}\SpecialCharTok{$}\NormalTok{state) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{min }\OtherTok{\textless{}{-}} \FunctionTok{which.min}\NormalTok{(pop)}
\NormalTok{murders}\SpecialCharTok{$}\NormalTok{population[min]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{st }\OtherTok{\textless{}{-}} \FunctionTok{which.min}\NormalTok{(pop)}
\NormalTok{murders}\SpecialCharTok{$}\NormalTok{state[st]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rank }\OtherTok{\textless{}{-}} \FunctionTok{rank}\NormalTok{(murders}\SpecialCharTok{$}\NormalTok{population)}
\NormalTok{state\_name }\OtherTok{\textless{}{-}}\NormalTok{ murders}\SpecialCharTok{$}\NormalTok{state}
\NormalTok{my\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{name =}\NormalTok{ state\_name, }\AttributeTok{rank =}\NormalTok{ rank)}
\NormalTok{my\_df}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{rank }\OtherTok{\textless{}{-}} \FunctionTok{rank}\NormalTok{(murders}\SpecialCharTok{$}\NormalTok{population)}
\NormalTok{ind }\OtherTok{\textless{}{-}} \FunctionTok{order}\NormalTok{(rank)}
\NormalTok{state\_name }\OtherTok{\textless{}{-}}\NormalTok{ murders}\SpecialCharTok{$}\NormalTok{state[ind]}
\NormalTok{my\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{name =}\NormalTok{ state\_name, }\AttributeTok{rank =}\NormalTok{ rank[ind])}
\NormalTok{my\_df}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Reg }\OtherTok{\textless{}{-}}\NormalTok{ murders}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{==} \StringTok{"Northeast"}
\NormalTok{NESTA }\OtherTok{\textless{}{-}}\NormalTok{ Reg }\SpecialCharTok{\&}\NormalTok{ low}
\NormalTok{murders}\SpecialCharTok{$}\NormalTok{state[NESTA]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{matabb }\OtherTok{\textless{}{-}} \FunctionTok{match}\NormalTok{( }\FunctionTok{c}\NormalTok{(}\StringTok{"AK"}\NormalTok{, }\StringTok{"MI"}\NormalTok{, }\StringTok{"IA"}\NormalTok{), murders}\SpecialCharTok{$}\NormalTok{abb)}
\NormalTok{murders}\SpecialCharTok{$}\NormalTok{state[matabb]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{matabb }\OtherTok{\textless{}{-}} \FunctionTok{which}\NormalTok{(murders}\SpecialCharTok{$}\NormalTok{abb }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"MA"}\NormalTok{, }\StringTok{"ME"}\NormalTok{, }\StringTok{"MI"}\NormalTok{, }\StringTok{"MO"}\NormalTok{, }\StringTok{"MU"}\NormalTok{))}
\NormalTok{murders}\SpecialCharTok{$}\NormalTok{abb[matabb]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{incorrectabb }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"MA"}\NormalTok{, }\StringTok{"ME"}\NormalTok{, }\StringTok{"MI"}\NormalTok{, }\StringTok{"MO"}\NormalTok{, }\StringTok{"MU"}\NormalTok{)}
\NormalTok{ind }\OtherTok{\textless{}{-}} \FunctionTok{which}\NormalTok{(}\SpecialCharTok{!}\NormalTok{incorrectabb}\SpecialCharTok{\%in\%}\NormalTok{murders}\SpecialCharTok{$}\NormalTok{abb)}
\NormalTok{incorrectabb[ind]}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Chapter2_R_basics_Byeon_files/figure-latex/unnamed-chunk-142-1.pdf}
...
\includegraphics{Chapter2_R_basics_Byeon_files/figure-latex/unnamed-chunk-143-1.pdf}
...
\includegraphics{Chapter2_R_basics_Byeon_files/figure-latex/unnamed-chunk-144-1.pdf}
...
\includegraphics{Chapter2_R_basics_Byeon_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\includegraphics{Chapter2_R_basics_Byeon_files/figure-latex/unnamed-chunk-147-1.pdf}
...
\FunctionTok{library}\NormalTok{(dslabs)}
\FunctionTok{data}\NormalTok{(murders)}
\NormalTok{population\_in\_millions }\OtherTok{\textless{}{-}} \FunctionTok{log10}\NormalTok{(murders}\SpecialCharTok{$}\NormalTok{population)}
...
\includegraphics{Chapter2_R_basics_Byeon_files/figure-latex/unnamed-chunk-148-1.pdf}
...
\includegraphics{Chapter2_R_basics_Byeon_files/figure-latex/unnamed-chunk-149-1.pdf}
...
\includegraphics{Chapter2_R_basics_Byeon_files/figure-latex/unnamed-chunk-150-1.pdf}
